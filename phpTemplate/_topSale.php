...
?>
 ...
 <!-- Top slae start here   -->
 <section id="topSale" style="width: 70%; margin: auto;">
            ...
            <div class="item py-2">
              <div class="product fontRale" style="display: flex; flex-direction: column; align-items: center;">
                ...
                <div class="text-center">
                  ...
                  <h3 class="fontsize12"><?php echo $item['item_name'] ?? 'samsung' ?></h3>
                  ...
                  <form method="post">
                    ...
                    <button type="submit" class="btn btn-warning fontsize12" name="top-sale-submit">Add to cart</button>
                  </form>
